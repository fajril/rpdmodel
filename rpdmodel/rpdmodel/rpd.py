...
class RPDModel():
    def __init__(self, year_rampup:int=2, drate:float=0.08, q_plateau_ratio:float=0.1, q_min_ratio:float=0.05):
    ...
    def _calc_plateau(self, vol_total:float, vol_rampup:float, vol_decline:float) -> np.ndarray:
